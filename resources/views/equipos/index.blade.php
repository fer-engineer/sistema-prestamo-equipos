...
<div class="flex items-center justify-between mb-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <a href="{{ route('equipos.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-md shadow hover:bg-blue-700 focus:outline-none">
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white">
                ...
                <tr class="bg-white hover:bg-gray-50">
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ $equipo->id }}</td>
...
<td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{{ $equipo->fecha_adquisicion ? $equipo->fecha_adquisicion->format('d/m/Y') : 'N/A' }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        ...
                        @can('update', $equipo)
                        <a href="{{ route('equipos.edit', $equipo) }}" class="inline-flex items-center px-3 py-1.5 mr-2 bg-green-100 text-green-800 border border-green-200 rounded hover:bg-green-200 text-sm">Modificar</a>
                        @endcan
                        @can('delete', $equipo)
