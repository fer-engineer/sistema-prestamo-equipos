...
<div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8 border-b border-gray-200">
    ...
    <div class="border-t border-gray-200 pt-6 flex justify-end space-x-4">
        <a href="{{ route('tipos_usuario.edit', $tipo_usuario) }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex items-center">
